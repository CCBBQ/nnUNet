...
class nnUNetTrainer(object):
    ...
    def run_training(self):
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            if loss_here < self.best_val_loss - self.early_stop_min_delta:
            ...
            if self.epochs_no_improve >= self.early_stop_patience:
                print(f"[Early Stopping] No val loss improvement in {self.early_stop_patience} epochs. Stopping training.")
                break
